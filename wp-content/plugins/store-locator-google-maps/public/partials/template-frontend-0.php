...
<div class="row Filter_section">
    <div class="col-xs-12 col-sm-4 search_filter">
        ...
        <p>
          <input type="text" data-submit="disable" data-provide="typeahead" tabindex="2" id="auto-complete-search" placeholder="<?php echo __( 'Enter a Location', 'asl_locator') ?>"  class="form-control typeahead isp_ignore">
                  ...
                  <div class="col-sm-9 col-md-8">
                      <div class="row">
                          <div class="col-sm-5 col-xs-5 drop_box_filter">
                              ...
                              <p><span><?php echo __( 'Categories','asl_locator') ?></span></p>
