						...
						<div class="panel-heading"><h3 class="panel-title">Detailed Information</h3></div>
					  	<div class="panel-body">
							...
							<div class="col-md-12">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-3">
			                                <button type="button" class="btn btn-success" data-toggle="smodal" data-target="#addmarkermodel">New</button>
			                            </div>
									</div>
							...
							<div class="col-md-12">
								<div class="col-md-6">
									<div class="form-group">
							            <label class="col-sm-3 control-label" for="txt-ordering">Ordering</label>
							            <div class="col-sm-9"><input type="number" id="txt-ordering" name="data[ordr]" placeholder="0" class="form-control validate[integer]"></div>
						           	</div>	
						           	<p class="red">Descending Order for the list, higher number on top. <br>Shortcode [ASL_STORELOCATOR sort_by="ordr"]</p>								
								</div>
							</div>
						</div>
					</div>
