		...
		<?php else : ?>
			...
			<li class="grve-empty-cart">
				...
				<div class="grve-h6"><?php esc_html_e( 'No products in the cart.', 'woocommerce' ); ?></div>
					<a class="grve-link-text" href="/products"><?php esc_html_e( 'Return to shop', 'woocommerce' ) ?></a>
				<!--
				<a class="grve-link-text" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'products' ) ) ); ?>"><?php esc_html_e( 'Return to shop', 'woocommerce' ) ?></a>
					-->			
</li>
