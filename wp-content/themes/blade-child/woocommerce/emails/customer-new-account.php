...
<html <?php language_attributes(); ?>>
	...
	<p><?php printf( __( 'Your account has been created and your username is %1$s . In this portal, you can order Ananda Professional’s products 24/7.', 'woocommerce' ), '<strong>' . esc_html( $user_login ) . '</strong>' ); ?></p>
